           ...
           
          {
            ...
            <div className='ed-grid m-grid-2'>
              <div className="main-banner__data">
                ...
                <p>{subtitle}</p>
                <a href="/cursos" className='button second-color'>Ver cursos</a>
              </div>
              ...
              courseBanner ?
                <div className='ed-grid m-grid-3'>
                  <div className="main-banner__data m-cols-2">
                    ...
                    {
                      especialidad &&
                      <p>Este curso forma parte de la especialidad <a href="/especialidades">{especialidad}</a></p>
                    }                    
                  </div>

                  <div className="img-container s-ratio-16-9 m-cols-1">
                    <img src={poster} alt="banner home" />
                  </div>
                </div>
              :
